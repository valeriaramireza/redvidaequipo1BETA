...
class CrugeAccessControlFilter extends CFilter
{
    ...
    protected function preFilter($filterChain)
    {
        ...
        $controllerItemName = "controller_" . strtolower(Yii::app()->getController()->id);

        $currentActionName = strtolower(Yii::app()->getController()->action->id);
        $actionItemName = "action_" . strtolower(Yii::app()->getController()->id) . "_" . $currentActionName;
