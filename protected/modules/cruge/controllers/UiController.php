        ...
        if (isset($_POST[CrugeUtil::config()->postNameMappings['CrugeLogon']])) {
            ...
            if ($model->validate()) {
                ...
                if ($model->login(false) == true) {
                    ...
                    // CWebUser::loginRequired que es donde finalmente se llama a setReturnUrlecho “<script languaje=’javascript’>alert(‘Material en depósito : “.$descripcion_material.”‘)</script>”;
